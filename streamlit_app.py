...
if uploaded_file:
    try:
        ...
        st.success("Dataset loaded! Preview below ⬇️")
...
st.markdown("### 🛠️ Edit keyword dictionaries (JSON)")
...
try:
    ...
    st.warning(f"⚠️ Invalid JSON provided – using default dictionaries. ({e})")
